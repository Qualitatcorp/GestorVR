<?php $this->breadcrumbs=array('Tipo de dispositivo','Administrar');?>
<?php echo BsHtml::pageHeader('Administrar','Tipo de dispositivo') ?>
<?php
		...
		<tr>
			...
			<td>
				<?= BsHtml::Button(BsHtml::icon(BsHtml::GLYPHICON_EDIT).' Ver', array(
					...
					'onclick'=>"window.location.href='viewTipo/$model->dit_id'",
				));?>
				<?php
					#modal de eliminar
					...
					$this->widget('bootstrap.widgets.BsModal', array(
					    ...
					    'footer' => array(
					        BsHtml::Button('Eliminar de todos modos', array(
								'onclick'=>"window.location.href='deleteTipo/$model->dit_id'",
							    'color' => BsHtml::BUTTON_COLOR_PRIMARY
							)),
				...
				<?= BsHtml::Button(BsHtml::icon(BsHtml::GLYPHICON_EDIT).' Modificar', array(
				    'color' => BsHtml::BUTTON_COLOR_PRIMARY,
				    'size' => BsHtml::BUTTON_SIZE_SMALL,
					'onclick'=>"window.location.href='editTipo/$model->dit_id'",
				));?>
			</td>
		</tr>
	<?php endforeach ?>
