<?php $this->breadcrumbs=array('Tipo de evaluación','Administrar');?>

<?php echo BsHtml::pageHeader('Administrar','Tipo de evaluación') ?>
			...
			<td>
				<?php
					...
					$this->widget('bootstrap.widgets.BsModal', array(
					    ...
					    'footer' => array(
					        BsHtml::Button('Eliminar de todos modos', array(
								'onclick'=>"window.location.href='deleteTipo/$model->tev_id'",
							    'color' => BsHtml::BUTTON_COLOR_PRIMARY
							)),
					...
					echo BsHtml::Button(BsHtml::icon(BsHtml::GLYPHICON_EDIT).' Modificar', array(
					    'color' => BsHtml::BUTTON_COLOR_PRIMARY,
					    'size' => BsHtml::BUTTON_SIZE_SMALL,
						'onclick'=>"window.location.href='editTipo/$model->tev_id'",
					));
				?>
			</td>
		</tr>
