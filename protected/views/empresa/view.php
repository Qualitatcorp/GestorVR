...
array_push($this->menu, 
	...
	array('label'=>Yii::t('Navbar','Ver Fichas'), 'url'=>array('adminFicha', 'id'=>$model->emp_id),'visible'=>Yii::app()->user->checkAccess('Cliente')||Yii::app()->user->checkAccess('Administrador'))
);
?>
