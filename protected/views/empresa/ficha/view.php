...
<div class="content">
	...
	<div class="row">
			<?=BsHtml::pageHeader("Ficha de evaluación","<br>".$model->dispositivo->empresa->nombre."<br>".$model->evaluacion->nombre."<br>".$model->trabajador->rut."<br>".$model->trabajador->nombreCompleto."<br>NOTA : ".$model->Nota,$htmlOptions=array('style'=>'position: relative;padding-top: 0px;'))?>
	</div>
	<div class="row">
